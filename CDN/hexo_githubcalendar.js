  ...
  if (document.getElementById("github_container")) {
    var github_canlendar = (git_user, git_githubapiurl, git_color) => {
      ...
      var github_info_box = (user, color) => {
        var html = "";
        html +=
          '<div id="git_tooltip_container"></div><div class="contrib-footer clearfix mt-1 mx-3 px-3 pb-1"><div class="float-left text-gray">數據來源 <a href="https://github.com/' +
          user +
          '" target="blank">@' +
          user +
      ...
      var github_main_box = (
        ...
        html +=
          ...
          "</div></div>";
        html +=
          '<div style="display:flex;width:100%"><div class="contrib-column contrib-column-first table-column"><span class="text-muted">過去一年Commit</span><span class="contrib-number">' +
          total +
          '</span><span class="text-muted">' +
          oneyearbeforeday +
          "&nbsp;-&nbsp;" +
          thisday +
          '</span></div><div class="contrib-column table-column"><span class="text-muted">最近一個月Commit</span><span class="contrib-number">' +
          thisweekdatacore +
          '</span><span class="text-muted">' +
          amonthago +
          "&nbsp;-&nbsp;" +
          thisday +
          '</span></div><div class="contrib-column table-column"><span class="text-muted">最近一周Commit</span><span class="contrib-number">' +
          weekdatacore +
          '</span><span class="text-muted">' +
          aweekago +
          "&nbsp;-&nbsp;" +
